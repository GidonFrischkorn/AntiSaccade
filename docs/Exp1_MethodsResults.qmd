...
ggplot() +
  ...
  geom_function(fun = expDecay,
                args = list(Baseline = 0.59, ActCue = 0.35, filterSpeed = 5, scale = "logit"),
                color = "darkred")  +
  geom_function(fun = linBinding,
                args = list(Baseline = 0.59, bindingAct = 2.76, scale = "logit"),
                color = "darkgreen") +
  geom_function(fun = BasePerformance,
                args = list(Baseline = 0.59, scale = "logit"),
                linetype = "dashed") +
  labs(y = "logit(p)",
       x = "CTI duration (s)",
...
ggplot() +
  xlim(0,0.5) +
  geom_function(fun = expDecay,
                args = list(Baseline = 0.59, ActCue = 0.35, filterSpeed =  5),
                color = "darkred")  +
  geom_function(fun = linBinding,
                args = list(Baseline = 0.59, bindingAct = 2.76),
                color = "darkgreen") +
  geom_function(fun = BasePerformance,
                args = list(Baseline = 0.59),
                linetype = "dashed") +
