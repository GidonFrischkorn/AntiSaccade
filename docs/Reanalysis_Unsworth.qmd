...
Unsworth et al. (2023) investigated if working memory capacity is more strongly related to performance in the anti- than in the pro-saccade task. For this, they included a composite working memory capacity score as a predictor of performance in the anti- and pro-saccade tasks. The below analyses do not exactly reproduce the results but closely match them (see below for details).
