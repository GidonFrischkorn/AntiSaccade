#' Raw Data of the first supplementary experiment in the Saccade Experiment Series
#'
#' @format ## `SuppExp1_data`
#' A data frame with 25920 rows and 13 columns:
#' \describe{
...
#' Raw Data of the second supplementary experiment in the Saccade Experiment Series
#'
#' @format ## `SuppExp2_data`
